...
<section>
    <h4 class="text-center text-center mb-5 border border-light  fs-5 fst-italic text-danger rounded col-12 col-md-6 col-lg-4 mx-auto p-2">Modification informations client</h4>
    <!-- S'il y a une erreur -->
    <?php if(!empty($error)) { ?>
